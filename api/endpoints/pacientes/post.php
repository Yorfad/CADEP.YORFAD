...
// Obtenemos el terapeuta o usuario que crea el registro
...
try {
    $stmt = $conn->prepare("
        INSERT INTO pacientes (nombre_completo, cui, fecha_nacimiento, sexo, direccion, telefono, correo, estudia, nivel_educativo, responsable_id, sede_id)
        VALUES (:nombre, :cui, :fecha, :sexo, :direccion, :telefono, :correo, :estudia, :nivel, :responsable, :sede)
    ");
    $stmt->execute([
